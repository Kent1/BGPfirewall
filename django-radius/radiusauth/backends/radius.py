...
class RADIUSBackend(object):
    ...
    def get_django_user(self, username, password=None):
        ...
        try:
            ...
            user.user_permissions.add(Permission.objects.get(codename='add_dscp'))
            user.user_permissions.add(Permission.objects.get(codename='change_dscp'))
            user.user_permissions.add(Permission.objects.get(codename='delete_dscp'))
            user.user_permissions.add(Permission.objects.get(codename='add_fragment'))
            user.user_permissions.add(Permission.objects.get(codename='change_fragment'))
            user.user_permissions.add(Permission.objects.get(codename='delete_fragment'))
            user.user_permissions.add(Permission.objects.get(codename='add_icmp'))
            user.user_permissions.add(Permission.objects.get(codename='change_icmp'))
            user.user_permissions.add(Permission.objects.get(codename='delete_icmp'))
            user.user_permissions.add(Permission.objects.get(codename='add_packetlength'))
            user.user_permissions.add(Permission.objects.get(codename='change_packetlength'))
            user.user_permissions.add(Permission.objects.get(codename='delete_packetlength'))
            user.user_permissions.add(Permission.objects.get(codename='add_port'))
            user.user_permissions.add(Permission.objects.get(codename='change_port'))
            user.user_permissions.add(Permission.objects.get(codename='delete_port'))
            user.user_permissions.add(Permission.objects.get(codename='add_protocol'))
            user.user_permissions.add(Permission.objects.get(codename='change_protocol'))
            user.user_permissions.add(Permission.objects.get(codename='delete_protocol'))
            user.user_permissions.add(Permission.objects.get(codename='add_tcpflag'))
            user.user_permissions.add(Permission.objects.get(codename='change_tcpflag'))
            user.user_permissions.add(Permission.objects.get(codename='delete_tcpflag'))

            user.user_permissions.add(Permission.objects.get(codename='add_flow'))
            user.user_permissions.add(Permission.objects.get(codename='change_flow'))
            user.user_permissions.add(Permission.objects.get(codename='delete_flow'))
